export const ERC1155_PACK_ABI = [
  { inputs: [], stateMutability: "nonpayable", type: "constructor" },
  { inputs: [], name: "AccountBalanceOverflow", type: "error" },
  { inputs: [], name: "AllPacksOpened", type: "error" },
  ...
  { inputs: [], name: "PendingReveal", type: "error" },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: "getRevealIdx",
    outputs: [{ internalType: "uint256", name: "revealIdx", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "user", type: "address" },
      {
        ...
        internalType: "struct IERC1155Pack.PackContent",
        name: "packContent",
        type: "tuple",
      },
